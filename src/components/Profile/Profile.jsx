...
const Profile = ({ user, isUser }) => {
  ...
  return (
    <div className="h-[85vh]  w-full flex justify-center items-center">
      <div className=" w-80  sm:w-96 mx-auto  bg-transparent rounded-lg overflow-hidden shadow-lg border rounded-md border-secondary">
        <div className="border-b px-4 pb-6">
          <div className="text-center my-4">
            <img
              className="h-32 w-32 rounded-full border-4   dark:border-secondary mx-auto my-4"
              src={
            ...
            />
            <div className="py-2">
              <h3 className="font-bold text-2xl capitalize mb-1">{username}</h3>
      ...
      >
        <ModalContent className="text-black">
          {(onClose) => <UpdateForm user={user} onClose={onClose} />}
        </ModalContent>
      </Modal>
    </div>
  );
